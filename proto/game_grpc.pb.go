...
type GameRequestClient interface {
	CreateGame(ctx context.Context, in *GameCreateBo, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *gameRequestClient) CreateGame(ctx context.Context, in *GameCreateBo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type GameRequestServer interface {
	CreateGame(context.Context, *GameCreateBo) (*emptypb.Empty, error)
...
func (UnimplementedGameRequestServer) CreateGame(context.Context, *GameCreateBo) (*emptypb.Empty, error) {
